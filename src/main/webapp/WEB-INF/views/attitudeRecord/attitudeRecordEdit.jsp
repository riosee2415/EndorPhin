...
<%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
		...
		<div class="modal" id="attitudeEdit" aria-hidden="true" style="display: none; z-index: 1100;">
       <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<form action="${cp}/attitudeRecord/attitudeRecordUpdate" method="post"> 
						...
						<li>
							근태 항목
								<select id="attitudecodeRecordEdit" name="attitudecode">
							...
							<li id="hiddenUser" style="margin-top: 20px">
									 <input class="inputCla" type="text" id="afterStartdayInsertRecordEdit" name="afterStartday">~
									<input type="hidden" id="startDateInsertRecordEdit" name="startday">
									<input type="hidden" id="useridInsertRecordEdit" name="userid">
									<input class="inputCla" type="text"  id="endDateInsertRecordEdit" name="endday" onchange="call()">
											
									<input style="margin-left: 60px;" type="text" id="basedaysRecordEdit">일수
									
									
									<input style="margin-left: 60px;" type="text" id="attitudememoRecordEdit" name="attitudememo">메모
								</li>	
								</ul>
								</div>
								</div>
...
<script>
	$(function() {
        $("#afterStartdayInsertRecordEdit").datepicker(   // inputbox 의 id 가 startDate 이겠죠.
        ...
        $("#endDateInsertRecordEdit").datepicker({dateFormat:'yy-mm-dd',showOn: 'button'
