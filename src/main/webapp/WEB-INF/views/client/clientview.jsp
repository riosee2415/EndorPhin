...
<body>
	...
	<input type="hidden" id="ccCode" />
	<input type="hidden" id="ccName" />
	<input type="hidden" id="cSalesNumber" />
	<input type="hidden" id="cManager" />
	<input type="hidden" id="cTelephone" />
	<input type="hidden" id="cFaxNumber" />
	<input type="hidden" id="cManagerEmail" />
	<input type="hidden" id="cBusiness" />
	<input type="hidden" id="cPlace" />
	<input type="hidden" id="cRelate" />
	<input type="hidden" id="cBusinessType" />
	<input type="hidden" id="cBankname" />
	<input type="hidden" id="cAccountNumber" />
	<input type="hidden" id="cUseStatus" />
			...
			<div class="modal-content modal-80size">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input style="width: 388px;" type="text" name="clBusiness" id="clBusiness" placeholder="업종/업태"> 
					</div>
					...
					<div class="form-group">
						...
						<input style="width: 388px" type="text" id="clRelate" placeholder="메모">
					</div>
	...
	<form id="insertFrm" action="${pageContext.request.contextPath }/insertClient" method="get">
		<input type="hidden" id="frmClCode" name="frmClCode" />
		<input type="hidden" id="frmClName" name="frmClName" />
		<input type="hidden" id="frmClSalesNumber" name="frmClSalesNumber" />
		<input type="hidden" id="frmClManager" name="frmClManager" />
		...
		<input type="hidden" id="frmClAccountNumber" name="frmClAccountNumber" />
		<input type="hidden" id="frmClRelate" name="frmClRelate" />
