...
<!-- 신규 사원 등록 -->
<div class="modal fade" id="myLargeModalInsert" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" >
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel" style="margin: auto; font-weight: bold; color : white;">신규 사원 등록</h4>
      </div>
